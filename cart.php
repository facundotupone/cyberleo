...
<script src="<?= htmlspecialchars(function_exists('cyberleo_safe_asset_url') ? cyberleo_safe_asset_url('assets/js/cart-checkout.js') : 'assets/js/cart-checkout.js', ENT_QUOTES, 'UTF-8') ?>" defer></script>
</body>
</html>
