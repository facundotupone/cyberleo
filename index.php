...
<body>
    ...
    <script src="<?= htmlspecialchars(function_exists('cyberleo_safe_asset_url') ? cyberleo_safe_asset_url('assets/js/catalog-cards.js') : (function_exists('cyberleo_asset_url') ? cyberleo_asset_url('assets/js/catalog-cards.js') : 'assets/js/catalog-cards.js'), ENT_QUOTES, 'UTF-8') ?>" defer></script>
    <script>
