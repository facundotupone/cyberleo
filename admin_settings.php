...
<link rel="stylesheet" href="<?= htmlspecialchars(cyberleo_safe_asset_url('assets/css/style.css'), ENT_QUOTES, 'UTF-8') ?>">
...
<script src="<?= htmlspecialchars(cyberleo_safe_asset_url('assets/js/theme-preview.js'), ENT_QUOTES, 'UTF-8') ?>" defer></script>
<script src="<?= htmlspecialchars(cyberleo_safe_asset_url('assets/js/home-content-preview.js'), ENT_QUOTES, 'UTF-8') ?>" defer></script>
<script src="<?= htmlspecialchars(cyberleo_safe_asset_url('assets/js/catalog-preview.js'), ENT_QUOTES, 'UTF-8') ?>" defer></script>
<script src="<?= htmlspecialchars(cyberleo_safe_asset_url('assets/js/checkout-preview.js'), ENT_QUOTES, 'UTF-8') ?>" defer></script>
</body>
</html>
