...
<script src="<?= htmlspecialchars(function_exists('cyberleo_safe_asset_url') ? cyberleo_safe_asset_url('assets/js/theme-preview.js') : 'assets/js/theme-preview.js', ENT_QUOTES, 'UTF-8') ?>" defer></script>
<script src="<?= htmlspecialchars(function_exists('cyberleo_safe_asset_url') ? cyberleo_safe_asset_url('assets/js/home-content-preview.js') : 'assets/js/home-content-preview.js', ENT_QUOTES, 'UTF-8') ?>" defer></script>
<script src="<?= htmlspecialchars(function_exists('cyberleo_safe_asset_url') ? cyberleo_safe_asset_url('assets/js/catalog-preview.js') : 'assets/js/catalog-preview.js', ENT_QUOTES, 'UTF-8') ?>" defer></script>
<script src="<?= htmlspecialchars(function_exists('cyberleo_safe_asset_url') ? cyberleo_safe_asset_url('assets/js/checkout-preview.js') : 'assets/js/checkout-preview.js', ENT_QUOTES, 'UTF-8') ?>" defer></script>
</body>
</html>
