...
<head>
    ...
    <link href="<?= htmlspecialchars(function_exists('cyberleo_safe_asset_url') ? cyberleo_safe_asset_url('assets/css/style.css') : 'assets/css/style.css', ENT_QUOTES, 'UTF-8') ?>" rel="stylesheet">
    <style><?php
