...
<body class="bg-light">
<nav class="navbar navbar-dark" style="background:#071a33"><div class="container"><a class="navbar-brand" href="admin_products.php"><?= htmlspecialchars($storeSettings['store_name']) ?> · Administración</a><div><a class="btn btn-outline-light btn-sm" href="admin_products.php">Productos</a> <a class="btn btn-outline-light btn-sm" href="admin_categories.php">Categorías</a> <a class="btn btn-outline-light btn-sm" href="admin_settings.php">Configuración</a> <a class="btn btn-outline-light btn-sm" href="admin_system.php">Sistema</a></div></div></nav>
